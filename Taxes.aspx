<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Taxes.aspx.cs" Inherits="Taxes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
      ...
      <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Tax Entry </h2>
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Setup / Tax Entry  </li>
        ...
        <br />
         ...
         <div class="container-fluid" >
             ...
             <span><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ...
                            <asp:TextBox ID="txt_brandname" placeholder="Tax Name"    runat="server" CssClass="form-control"></asp:TextBox>
             ...
             <span><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                            ...
                            <asp:TextBox ID="txt_rate"  TextMode ="Number" placeholder="Tax rate"    runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <ItemTemplate>
                     <asp:HiddenField ID="hd_id" Value='<%#Eval("taxid") %>' runat="server"></asp:HiddenField>
                   
                      <asp:HiddenField ID="HiddenField1" Value='<%#Eval("taxname") %>' runat="server"></asp:HiddenField>
                          <asp:HiddenField ID="hd_rate" Value='<%#Eval("taxrate") %>' runat="server"></asp:HiddenField>
                      <asp:HiddenField ID="hd_status" Value='<%#Eval("taxstatus") %>' runat="server"></asp:HiddenField>
                <asp:LinkButton ID="btn_selectbranch" CssClass="btn btn-primary btn-sm " onclick="btn_selectbranch_Click" runat="server" ><i class="fa fa-edit"></i></asp:LinkButton>
                      ...
                      OnClientClick="return getConfirmation_verify(this, 'Please confirm','Are you sure you want to Delete?');"
                       ><i class="fa fa-trash"></i></asp:LinkButton>
                                                ...
                                                <asp:BoundField DataField="taxname" HeaderText="Tax Name" ItemStyle-HorizontalAlign="Left" />
                                                  <asp:BoundField DataField="taxrate" HeaderText="Tax Rate %" ItemStyle-HorizontalAlign="Left" />
                                                 <asp:BoundField DataField="taxstatus" HeaderText="Status" ItemStyle-HorizontalAlign="Left" />
