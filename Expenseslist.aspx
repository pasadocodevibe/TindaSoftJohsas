<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Expenseslist.aspx.cs" Inherits="Expenseslist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
      ...
      <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">List of Expenses</h2>
                  ...
                  <div class="card">
                   ...
                   <div class="card-close">
                    <span>
                      ...
                      runat="server" PostBackUrl="~/ExpensesEntry.aspx"  ToolTip="Shortcut key: alt+A" AccessKey="A"><i class="fa fa-plus"></i></asp:LinkButton>
                      ...
                      <asp:GridView ID="gv_masterlist" runat="server" 
                              ...
                              onrowdatabound="gv_masterlist_RowDataBound" GridLines="None" PagerSettings-Mode="NumericFirstLast">
                                            <Columns>
                                             <asp:TemplateField>
            <ItemTemplate>
                     <asp:HiddenField ID="hd_id" Value='<%#Eval("expid") %>' runat="server"></asp:HiddenField>
           ...
           #
            ...
            <ItemTemplate>
                ...
                <asp:Label ID="lbl_no" runat="server" Text="<%# Container.DataItemIndex + 1 %>  "></asp:Label>
                                                ...
                                                <asp:BoundField DataField="expdate" HeaderText="Date Expense"  DataFormatString="{0:MMM. dd, yyyy}" ItemStyle-HorizontalAlign="Left" />
                                                <asp:BoundField DataField="name" HeaderText="Name" ItemStyle-HorizontalAlign="Left" />
                                                
                                                <asp:BoundField DataField="expamount" HeaderText="Amount"    ItemStyle-HorizontalAlign="Left" />
                                                 <asp:BoundField DataField="expnote" HeaderText="Note" ItemStyle-HorizontalAlign="Left" />
