<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Identity.aspx.cs" Inherits="Identity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
      ...
      <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Customer identity Entry </h2>
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Setup /Customer identity Entry  </li>
        ...
        <br />
         ...
         <div class="container-fluid" >
              <div class="row">
               ...
               <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Proof of identity Entry</h3>
                    </div>
                    <div class="card-body">
             ...
             <span><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ...
                            <asp:TextBox ID="txt_brandname" placeholder="Identity Name"    runat="server" CssClass="form-control"></asp:TextBox>
              ...
              <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
                  ...
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center"  style="height: 65px">
                      <h3 class="h4">List of Proof of identity</h3>
                    </div>
                    <div class="card-body">
            ...
            <ItemTemplate>
                     <asp:HiddenField ID="hd_id" Value='<%#Eval("id") %>' runat="server"></asp:HiddenField>
                      ...
                      <asp:HiddenField ID="HiddenField1" Value='<%#Eval("name") %>' runat="server"></asp:HiddenField>
                ...
                <asp:LinkButton ID="btn_selectbranch" CssClass="btn btn-primary btn-sm " onclick="btn_selectbranch_Click" runat="server" ><i class="fa fa-edit"></i></asp:LinkButton>
                      ...
                      OnClientClick="return getConfirmation_verify(this, 'Please confirm','Are you sure you want to Delete?');"
                       ><i class="fa fa-trash"></i></asp:LinkButton>
                                                ...
                                                <asp:BoundField DataField="name" HeaderText="Identity Name" ItemStyle-HorizontalAlign="Left" />
