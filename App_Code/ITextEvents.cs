    ...
    public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
    {
      ...
      //  }
        //Add paging to footer
        {
           ...
           cb.SetTextMatrix(document.PageSize.GetRight(80), document.PageSize.GetBottom(9));
           cb.ShowText(text);
            cb.EndText();
            float len = bf.GetWidthPoint(text, 9);
            cb.AddTemplate(footerTemplate, document.PageSize.GetRight(80) + len, document.PageSize.GetBottom(9));
        }

        //Row 2
        PdfPCell pdfCell4 = new PdfPCell(new Phrase("", baseFontBig));
