<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Discount.aspx.cs" Inherits="Discount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
  <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Discount Entry </h2>
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Setup / Discount Entry  </li>
        ...
        <br />
         ...
         <div class="container-fluid" >
             ...
             <span><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ...
                            <asp:TextBox ID="txt_brandname" placeholder="Discount Name"    runat="server" CssClass="form-control"></asp:TextBox>
           
                        </div>
                         <div class="form-group">Discount Rate %
                          <label class="form-control-label">
             <span><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                ErrorMessage=" * required!" Font-Size="Small" ForeColor="#CC3300" 
                                ControlToValidate="txt_rate" SetFocusOnError="True" ValidationGroup="add"></asp:RequiredFieldValidator>
                            
                                </span>
                        
                          </label>
                            <asp:TextBox ID="txt_rate"  TextMode ="Number" placeholder="Discount rate"    runat="server" CssClass="form-control"></asp:TextBox>
              ...
              <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
                  ...
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center"  style="height: 65px">
                      <h3 class="h4">List of Discount</h3>
                    </div>
                    <div class="card-body">
    <div class="table-responsive">   
            ...
            <ItemTemplate>
                     <asp:HiddenField ID="hd_id" Value='<%#Eval("discountid") %>' runat="server"></asp:HiddenField>
                   
                      <asp:HiddenField ID="HiddenField1" Value='<%#Eval("discountname") %>' runat="server"></asp:HiddenField>
                          <asp:HiddenField ID="hd_rate" Value='<%#Eval("discountrate") %>' runat="server"></asp:HiddenField>
                      <asp:HiddenField ID="hd_status" Value='<%#Eval("disstatus") %>' runat="server"></asp:HiddenField>
                <asp:LinkButton ID="btn_selectbranch" CssClass="btn btn-primary btn-sm " onclick="btn_selectbranch_Click" runat="server" ><i class="fa fa-edit"></i></asp:LinkButton>
                      ...
                      OnClientClick="return getConfirmation_verify(this, 'Please confirm','Are you sure you want to Delete?');"
                       ><i class="fa fa-trash"></i></asp:LinkButton>
                                                ...
                                                <asp:BoundField DataField="discountname" HeaderText="Discount Name" ItemStyle-HorizontalAlign="Left" />
                                                  <asp:BoundField DataField="discountrate" HeaderText="Rate %" ItemStyle-HorizontalAlign="Left" />
                                                 <asp:BoundField DataField="disstatus" HeaderText="Status" ItemStyle-HorizontalAlign="Left" />
