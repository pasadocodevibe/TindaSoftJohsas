<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="pCategory.aspx.cs" Inherits="pCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
      ...
      <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Item Category </h2>
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Product & Services / Item Category  </li>
        ...
        <br />
         ...
         <div class="container-fluid" >
              <div class="row">
               ...
               <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Item Category Entry</h3>
                    </div>
                    <div class="card-body">
              ...
              <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
                  ...
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center"  style="height: 65px">
                      <h3 class="h4">List of Item Category</h3>
                    </div>
                    <div class="card-body">
            ...
            <ItemTemplate>
                     <asp:HiddenField ID="hd_id" Value='<%#Eval("pcategid") %>' runat="server"></asp:HiddenField>
                   
                      <asp:HiddenField ID="HiddenField1" Value='<%#Eval("pcategname") %>' runat="server"></asp:HiddenField>
                       
                      <asp:HiddenField ID="hd_status" Value='<%#Eval("pcategstatus") %>' runat="server"></asp:HiddenField>
                <asp:LinkButton ID="btn_selectbranch" CssClass="btn btn-primary btn-sm " onclick="btn_selectbranch_Click" runat="server" ><i class="fa fa-edit"></i></asp:LinkButton>
                      ...
                      OnClientClick="return getConfirmation_verify(this, 'Please confirm','Are you sure you want to Delete?');"
                       ><i class="fa fa-trash"></i></asp:LinkButton>
                                                ...
                                                <asp:BoundField DataField="pcategname" HeaderText="Category Name" ItemStyle-HorizontalAlign="Left" />
                                                 <asp:BoundField DataField="pcategstatus" HeaderText="Status" ItemStyle-HorizontalAlign="Left" />
