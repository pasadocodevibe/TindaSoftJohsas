<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Copy of Home.aspx.cs" Inherits="Home" %>
                ...
                <div class="col-lg-6">
                 <div class="bar-chart-example card no-margin-bottom">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4"> Sales vs Expenses</h3>
                    </div>
                    <div class="card-body">
                        
                      <asp:Literal ID="ltScriptsDataMonthly" runat="server"></asp:Literal>  
                     <asp:Panel ID="Panel1" runat="server" ScrollBars="Both" Height="150">       
                             <div id="Ch_BarChart_Monthly"    /> 
                    </asp:Panel>
                  </div>
