<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Report_SalesTaxLiability.aspx.cs" Inherits="Report_SalesTaxLiability" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
      ...
      <header class="page-header">
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Sales Tax Liability </li>
              ...
              <div class="row">
               ...
               <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4"> Sales Tax Liability</h3>
                    </div>
                    <div class="card-body">
