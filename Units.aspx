<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Units.aspx.cs" Inherits="Units" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
      ...
      <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Units Entry </h2>
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Setup / Units Entry  </li>
        ...
        <br />
         ...
         <div class="container-fluid" >
              <div class="row">
               ...
               <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Unit of Measurement Entry</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group">Unit of measurement
             ...
             <span><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ...
                            <asp:TextBox ID="txt_brandname" placeholder="Unit of measurement"    runat="server" CssClass="form-control"></asp:TextBox>
            ...
            <ItemTemplate>
                     <asp:HiddenField ID="hd_id" Value='<%#Eval("uomid") %>' runat="server"></asp:HiddenField>
                   
                      <asp:HiddenField ID="HiddenField1" Value='<%#Eval("uomname") %>' runat="server"></asp:HiddenField>
                       
                      <asp:HiddenField ID="hd_status" Value='<%#Eval("uomstatus") %>' runat="server"></asp:HiddenField>
                <asp:LinkButton ID="btn_selectbranch" CssClass="btn btn-primary btn-sm " onclick="btn_selectbranch_Click" runat="server" ><i class="fa fa-edit"></i></asp:LinkButton>
                      ...
                      OnClientClick="return getConfirmation_verify(this, 'Please confirm','Are you sure you want to Delete?');"
                       ><i class="fa fa-trash"></i></asp:LinkButton>
                                                ...
                                                <asp:BoundField DataField="uomname" HeaderText="Unit of Measurement" ItemStyle-HorizontalAlign="Left" />
                                                 <asp:BoundField DataField="uomstatus" HeaderText="Status" ItemStyle-HorizontalAlign="Left" />
