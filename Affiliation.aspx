<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Affiliation.aspx.cs" Inherits="Affiliation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
      ...
      <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Affiliation Entry </h2>
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Setup /Affiliation Entry  </li>
        ...
        <br />
         ...
         <div class="container-fluid" >
              <div class="row">
               ...
               <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">Affiliation Entry</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group">Affiliation Name
             ...
             <span><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                            ...
                            <asp:TextBox ID="txt_brandname" placeholder="Affiliation Name"    runat="server" CssClass="form-control"></asp:TextBox>
              ...
              <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
                  ...
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center"  style="height: 65px">
                      <h3 class="h4">List of Affiliation</h3>
                    </div>
                    <div class="card-body">
                ...
                <asp:LinkButton ID="btn_selectbranch" CssClass="btn btn-primary btn-sm " onclick="btn_selectbranch_Click" runat="server" ><i class="fa fa-edit"></i></asp:LinkButton>
                      ...
                      OnClientClick="return getConfirmation_verify(this, 'Please confirm','Are you sure you want to Delete?');"
                       ><i class="fa fa-trash"></i></asp:LinkButton>
                                                ...
                                                <asp:BoundField DataField="name" HeaderText="Affiliation Name" ItemStyle-HorizontalAlign="Left" />
